#define m1 2  //Right Motor MA1
#define m2 3  //Right Motor MA2
...
void loop() {
  ...
  if((s1 == 0) && (s2 == 0) && (s3 == 1) && (s4 == 0) && (s5 == 0))
  {
    ...
    analogWrite(e1, enable1_speed); //you can adjust the speed of the motors from 0-255
    analogWrite(e2, enable2_speed); //you can adjust the speed of the motors from 0-255
